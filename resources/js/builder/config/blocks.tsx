...
import { BentoHero } from '../blocks/BentoHero';
import { DiscountBanners } from '../blocks/DiscountBanners';
import { CompactRow } from '../blocks/CompactRow';
import {
    STARTER_BRAND_ITEMS,
...
export const BLOCK_SCHEMAS: Record<string, BlockSchema> = {
    ...
    Newsletter: {
        Component: Newsletter as ComponentType<Record<string, unknown>>,
        category: 'marketing',
        fields: [
            group('Content'),
            ta('title', 'Title'),
    ...
    BentoHero: {
        Component: BentoHero as ComponentType<Record<string, unknown>>,
        category: 'hero',
        fields: [
            group('Content'),
            t('eyebrow', 'Eyebrow'),
            ...
            categoryField('categoryId', 'Category'),
            handpickField(),
            num('limit', 'Number of products', 1, 12),
            ...sectionStyleFields(),
            group('Visibility'),
            ...visibility(),
        ],
    ...
    DiscountBanners: {
        Component: DiscountBanners as ComponentType<Record<string, unknown>>,
        category: 'banners',
        fields: [
            group('Left banner'),
            image('leftImage', 'Image', 800, 600),
    ...
    CompactRow: {
        Component: CompactRow as ComponentType<Record<string, unknown>>,
        category: 'products',
        fields: [
            group('Content'),
            t('title', 'Title'),
